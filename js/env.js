/* ============================================
   ...
   falling back to the local js/config.js for
   pure-static local dev.
   Must run AFTER js/config.js and BEFORE
...
(function () {
  ...
  try {
    ...
    // /api/config unavailable (e.g. static-only serve) — js/config.js wins.
  }
})();
